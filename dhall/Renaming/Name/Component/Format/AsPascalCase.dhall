{-|
# Renaming.Name.Component.Format.AsPascalCase
...
in  Autotagical.Renaming.Name.Component.Format.AsPascalCase
      [Autotagical.Renaming.Name.Component.text "toPascal-case"]
```
...
in  format Case.AsPascalCase : List Component → Component
