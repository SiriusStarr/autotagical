{-|
# Renaming.Name.Component.Format.\`As Title Case\`
...
in  Autotagical.Renaming.Name.Component.Format.`As Title Case`
      [Autotagical.Renaming.Name.Component.text "toTitle-case"]
```
