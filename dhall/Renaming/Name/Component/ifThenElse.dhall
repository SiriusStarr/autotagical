...
in  Autotagical.Renaming.Name.Component.ifThenElse
      (Autotagical.Predicate.hasTag (Autotagical.Tags.tag "tag1"))
      [ Autotagical.Renaming.Name.Component.text "Has the tag tag1" ]
      [ Autotagical.Renaming.Name.Component.text "Does not have the tag tag1" ]
```
