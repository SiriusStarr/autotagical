...
forbid leading tag separators.  For example, `[,tag1,tag2]` would fail to parse
...
in    Autotagical.Input.tagSpacesFormat
    ⫽ Autotagical.Input.With.LeadingTagSeparator.forbidden
```
...
in    { leadingTagSeparator = SeparatorRequirement.Forbidden }
