...
exactly `N` of the predicates evaluate to true; otherwise, evaluates to false.

## Examples

Tags: `tag1`, `tag2`, `tag3`

* `exactly 2 [hasTag "tag1", hasTag "tag2", hasTag "tag3"]: False`

* `exactly 2 [hasTag "tag1", hasTag "tag2", hasTag "tag4"]: True`

* `exactly 2 [hasTag "tag1", hasTag "tag4"]: False`
...
in  Autotagical.Predicate.exactly
      2
...
let exactly
    ...
    = λ(n : Natural) →
      λ(predicates : List Predicate) →
        between (Bound.Bound n) (Bound.Bound n) predicates
