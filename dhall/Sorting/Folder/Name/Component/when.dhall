{-
# Sorting.Folder.Name.Component.when
...
in  Autotagical.Sorting.Folder.Name.Component.when
      (Autotagical.Predicate.hasTag (Autotagical.Tags.tag "tag1"))
      [ Autotagical.Sorting.Folder.Name.Component.text "Does have the tag tag1"
      ]
```
